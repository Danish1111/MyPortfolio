...
## <span style="color:blue">iTrade - Agri Trading (iOS)</span>
...
- MapKit
  ...
  ## <span style="color:blue">Hood - Discover Truth (iOS)</span>

**App Description:**
Hood is a social network where users can share their true stories without revealing their identity, so they don’t have to worry about being judged. I developed this app using Swift 5 with the MVC architecture. It has more than 1 million users, and I handled the entire development process on my own as a freelance project.

<div align="center">
  <img src="https://github.com/Danish1111/MyPortfolio/blob/main/assets/screenshot1.png" width="250" height="400" alt="App GIF 1" style="margin-right: 20px; margin-bottom: 20px;">
  <img src="https://github.com/Danish1111/MyPortfolio/blob/main/assets/screenshot2.png" width="250" height="400" alt="App GIF 2" style="margin-right: 20px; margin-bottom: 20px;">
  <img src="https://github.com/Danish1111/MyPortfolio/blob/main/assets/screenshot3.png" width="250" height="400" alt="App GIF 3" style="margin-bottom: 20px;">
</div>
...
- Twitter Apis Integration
  ...
  ## <span style="color:blue">AgriBazaar (iOS)</span>

**App Description:**
agriBazaar is a one stop agri-trading platform that connects thousands of Indian farmers, traders, millers and
processors located in 25+ states across the nation.

<div align="center">
  <img src="https://github.com/Danish1111/MyPortfolio/blob/main/assets/screenshot4.png" width="250" height="400" alt="App GIF 1" style="margin-right: 20px; margin-bottom: 20px;">
  <img src="https://github.com/Danish1111/MyPortfolio/blob/main/assets/screenshot5.png" width="250" height="400" alt="App GIF 2" style="margin-right: 20px; margin-bottom: 20px;">
  <img src="https://github.com/Danish1111/MyPortfolio/blob/main/assets/screenshot6.png" width="250" height="400" alt="App GIF 3" style="margin-bottom: 20px;">
</div>
